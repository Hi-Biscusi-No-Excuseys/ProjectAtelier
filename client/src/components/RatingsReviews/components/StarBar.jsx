...
export default function StarBar ({percentage}) {
  ...
  return (
    <span style={{ display: 'inline-flex', direction: 'row', alignItems: 'center', width: '100px', position: 'relative'}}>
      <span style={{ height: '0.6rem', width: `${perc}%`, backgroundColor: 'green', zIndex: 999}}></span>
      <span style={{ height: '0.6rem', width: '100%', backgroundColor: '#d4d4d4', position: 'absolute', top: 0, left: 0}}></span>
    </span>
  )
}